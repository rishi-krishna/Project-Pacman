...
def depthFirstSearch(problem):
    ...
    """
    "*** RISHI KRISHNA CODE DFS-START ***"
    
    # TO keep track of both nodes that are visited
    visited = set()
    ...
    "*** RISHI KRISHNA CODE DFS-END ***"    
    util.raiseNotDefined()

def breadthFirstSearch(problem):
    """Search the shallowest nodes in the search tree first."""
    "*** RISHI KRISHNA CODE BFS-START ***"
    # TO keep track of both nodes that are visited
    visited = set()
    ...
    "***RISHI KRISHNA CODE BFS-END***"
    util.raiseNotDefined()

def uniformCostSearch(problem):
    """Search the node of least total cost first."""
    "***RISHI KRISHNA CODE Uniformcostsearch -START***"
    # TO keep track of both nodes that are visited
    visited = set()
    ...
    "***RISHI KRISHNA CODE Uniformcostsearch -END***"
    util.raiseNotDefined()
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    "***RISHI KRISHNA CODE astarsearch -START***"
    # TO keep track of both nodes that are visited
    visited = set()
    ...
    "***RISHI KRISHNA CODE astarsearch -END***"
    util.raiseNotDefined()
